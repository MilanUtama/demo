...
map.getView().fit([11323400.113324, 330062.966234, 11336323.437913, 339460.442829], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MIROS Star Rating demo map</h2>';
        return titleElement;
    })(),
